          ...
          <div className="container">
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
              ...
              <div style={{
                ...
                <span>•</span>
                <span><strong>Version:</strong> 0.11.0</span>
                <span>•</span>
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <a
                    href="https://github.com/peacprotocol/peac/archive/refs/tags/v0.11.0.zip"
                    style={{
                      display: 'inline-flex',
                      alignItems: 'center',
                      gap: 'var(--space-2)',
                  ...
                  <a
                    href="https://github.com/peacprotocol/peac/archive/refs/tags/v0.11.0.tar.gz"
                    style={{
                      display: 'inline-flex',
                      alignItems: 'center',
                      gap: 'var(--space-2)',
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <code style={{ background: 'var(--surface-card)', padding: 'var(--space-2) var(--space-3)', borderRadius: 'var(--radius-md)', fontSize: 'var(--text-xs)', fontFamily: 'var(--font-mono)', overflowX: 'auto', display: 'block' }}>go get github.com/peacprotocol/peac/sdks/go@v0.11.0</code>
                </div>
              </div>
