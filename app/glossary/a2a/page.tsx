...
export const metadata: Metadata = {
  title: "A2A - Agent-to-Agent Communication - Originary",
  ...
  alternates: { canonical: "https://www.originary.xyz/glossary/a2a/" },
    ...
    <div className="wrap">
      ...
      <main className="container" style={{ maxWidth: '900px', margin: '0 auto', paddingTop: 'var(--space-24)', paddingBottom: 'var(--space-16)' }}>
        <nav aria-label="Breadcrumb" style={{ fontSize: 'var(--text-sm)', marginBottom: 'var(--space-6)', color: 'var(--gray-600)' }}>
          ...
          {' '}/{' '}
          <span style={{ color: 'var(--gray-900)' }}>A2A</span>
        </nav>
        ...
        <h1 style={{ fontSize: 'var(--text-5xl)', fontWeight: 700, marginBottom: 'var(--space-6)', lineHeight: 1.1, color: 'var(--gray-900)' }}>
          A2A <span style={{ fontSize: 'var(--text-3xl)', color: 'var(--gray-600)', fontWeight: 400 }}>(Agent-to-Agent)</span>
        </h1>
        ...
        <div style={{ fontSize: 'var(--text-base)', lineHeight: 1.8, color: 'var(--gray-700)' }}>
          ...
          <div className="card" style={{ marginBottom: 'var(--space-8)' }}>
            <ul style={{ paddingLeft: 'var(--space-6)', margin: 0 }}>
              <li style={{ marginBottom: 'var(--space-3)' }}>
                <strong>Discovery</strong> - Agents find services, policies, and pricing through machine-readable formats (<code style={{ background: 'var(--gray-100)', padding: '2px 6px', borderRadius: 'var(--radius-sm)' }}>/.well-known/peac.txt</code>, <Link href="/glossary/aipref/" style={{ color: 'var(--brand-primary)', textDecoration: 'underline' }}>AIPREF</Link>)
              </li>
              <li style={{ marginBottom: 'var(--space-3)' }}>
                <strong>Negotiation</strong> - Automated agreement on terms, pricing, and service levels without human approval flows
              </li>
              <li style={{ marginBottom: 'var(--space-3)' }}>
                <strong>Payment</strong> - Direct agent-initiated payments using protocols like <Link href="/glossary/http-402-payment-required/" style={{ color: 'var(--brand-primary)', textDecoration: 'underline' }}>HTTP 402</Link> and <Link href="/glossary/x402/" style={{ color: 'var(--brand-primary)', textDecoration: 'underline' }}>x402</Link>
              </li>
              <li style={{ marginBottom: 'var(--space-3)' }}>
          ...
          <div className="card" style={{ marginBottom: 'var(--space-8)' }}>
            <ol style={{ paddingLeft: 'var(--space-6)', margin: 0 }}>
              ...
              <li style={{ marginBottom: 'var(--space-3)' }}>
                <strong>Agent reads policies</strong> - Fetches machine-readable terms from <code style={{ background: 'var(--gray-100)', padding: '2px 6px', borderRadius: 'var(--radius-sm)' }}>/.well-known/peac.txt</code>
              </li>
              <li style={{ marginBottom: 'var(--space-3)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 'var(--space-6)', marginBottom: 'var(--space-8)' }}>
            <div className="card">
              ...
              <p style={{ color: 'var(--gray-600)', lineHeight: 1.7, margin: 0, fontSize: 'var(--text-sm)' }}>
                Policy discovery + verifiable receipts
              </p>
            </div>
            <div className="card">
              <h3 style={{ fontSize: 'var(--text-lg)', fontWeight: 600, marginBottom: 'var(--space-3)', color: 'var(--gray-900)' }}>
                <Link href="/glossary/http-402-payment-required/" style={{ color: 'var(--brand-primary)', textDecoration: 'none' }}>HTTP 402 / x402</Link>
              </h3>
              <p style={{ color: 'var(--gray-600)', lineHeight: 1.7, margin: 0, fontSize: 'var(--text-sm)' }}>
            ...
            <div className="card">
              <h3 style={{ fontSize: 'var(--text-lg)', fontWeight: 600, marginBottom: 'var(--space-3)', color: 'var(--gray-900)' }}>
                <Link href="/glossary/aipref/" style={{ color: 'var(--brand-primary)', textDecoration: 'none' }}>AIPREF</Link>
              </h3>
              <p style={{ color: 'var(--gray-600)', lineHeight: 1.7, margin: 0, fontSize: 'var(--text-sm)' }}>
          ...
          <ul style={{ paddingLeft: 'var(--space-6)', margin: 0 }}>
            <li style={{ marginBottom: 'var(--space-3)' }}>
              <Link href="/glossary/agentic-web/" style={{ color: 'var(--brand-primary)', textDecoration: 'underline' }}>Agentic Web</Link> - Infrastructure enabling A2A communication
            </li>
            <li style={{ marginBottom: 'var(--space-3)' }}>
              <Link href="/products/gateway-402/" style={{ color: 'var(--brand-primary)', textDecoration: 'underline' }}>Gateway 402</Link> - Payment infrastructure for A2A commerce
            </li>
            <li style={{ marginBottom: 'var(--space-3)' }}>
              <Link href="/solutions/api-providers/" style={{ color: 'var(--brand-primary)', textDecoration: 'underline' }}>API Providers solution</Link> - Monetize agent access with A2A protocols
            </li>
            <li style={{ marginBottom: 0 }}>
              <Link href="/developers/" style={{ color: 'var(--brand-primary)', textDecoration: 'underline' }}>Developer Documentation</Link> - Implement A2A in your services
            </li>
          </ul>
        </div>
