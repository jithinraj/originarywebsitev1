        ...
        <PageSection paddingTop={32} paddingBottom={64}>
          <div className="home-about-twocol">
            ...
            <Reveal delay={120}>
              <div>
                <p className="home-about-body" style={{ marginTop: 0 }}>
                  Poem, Inc. is a Delaware corporation. Originary&trade; is
                  Poem, Inc.&rsquo;s software and developer-tools brand. Through
                  Originary, Poem publishes and maintains PEAC Protocol and
                  develops Originary Verify.
                </p>
                <p className="home-about-body">
                  PEAC software is distributed through GitHub and package
                  registries under the Apache-2.0 license.
                </p>
                <p className="home-about-body">
