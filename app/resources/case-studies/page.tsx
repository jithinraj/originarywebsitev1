          ...
          <div className="container">
            <div className="content">
              <div className="case-study-cta">
                ...
                <p>PEAC is Apache-2.0 and ships with 35 npm packages, Express middleware, and a conformance runner. If you&rsquo;re integrating signed receipts into your stack, we&rsquo;d like to document the implementation with you.</p>
