  ...
  const faqJsonLd = {
    ...
    "mainEntity": [
      ...
      },
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "PEAC is at version 0.14.0; the goal is to earn 1.0 through multi-implementation, conformance, and standards work."
        }
      }
    ]
  }
            ...
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                ...
                >
                  ...
                  <p style={{ fontSize: 'var(--text-base)', color: 'var(--text-secondary)', lineHeight: 1.7, margin: 0 }}>
                    PEAC is at version <code style={{ background: 'var(--surface-card)', padding: '2px 6px', borderRadius: '4px' }}>0.14.0</code>; the goal is to earn <code style={{ background: 'var(--surface-card)', padding: '2px 6px', borderRadius: '4px' }}>1.0</code> through multi-implementation, conformance, and standards work.
                  </p>
                </div>
              </div>
            </div>
