...
const integrations = [
  ...
  },
  {
    id: 'mcp',
    title: 'MCP Server',
    description: 'Open-source MCP tool server (@peac/mcp-server) with 5 tools for receipt verification, inspection, issuance, and bundling. Works with Claude Desktop, Cursor, and custom agents.',
