        ...
        <div className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: '0 var(--space-6)' }}>
          ...
          <div className="card" style={{
            ...
            <h2 style={{ fontSize: 'var(--text-xl)', fontWeight: 600, marginBottom: 'var(--space-4)', display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
              <FileText size={20} style={{ color: 'var(--accent-brand)' }} />
              Abstract
            </h2>
          ...
          <div className="card" style={{
            ...
            <div style={{ display: 'grid', gap: 'var(--space-4)' }}>
              <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                <span style={{ color: 'var(--accent-brand)', fontWeight: 600, minWidth: '24px' }}>1.</span>
                <div>
                  <strong style={{ color: 'var(--text-primary)' }}>Decentralized verification</strong>
                  <p style={{ color: 'var(--text-secondary)', margin: 'var(--space-1) 0 0 0', fontSize: 'var(--text-sm)' }}>Receipts verify offline using JWKS. No central authority required.</p>
                </div>
              </div>
              <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                <span style={{ color: 'var(--accent-brand)', fontWeight: 600, minWidth: '24px' }}>2.</span>
                <div>
                  <strong style={{ color: 'var(--text-primary)' }}>Rail-neutral</strong>
                  <p style={{ color: 'var(--text-secondary)', margin: 'var(--space-1) 0 0 0', fontSize: 'var(--text-sm)' }}>Settlement is optional and adapter-based. PEAC works with any payment rail or none.</p>
                </div>
              </div>
              <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                <span style={{ color: 'var(--accent-brand)', fontWeight: 600, minWidth: '24px' }}>3.</span>
                <div>
                  <strong style={{ color: 'var(--text-primary)' }}>Privacy-preserving</strong>
                  <p style={{ color: 'var(--text-secondary)', margin: 'var(--space-1) 0 0 0', fontSize: 'var(--text-sm)' }}>Identity can be pseudonymous. Receipts contain only what the issuer chooses to include.</p>
                </div>
              </div>
              <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                <span style={{ color: 'var(--accent-brand)', fontWeight: 600, minWidth: '24px' }}>4.</span>
                <div>
                  <strong style={{ color: 'var(--text-primary)' }}>HTTP-native</strong>
                  <p style={{ color: 'var(--text-secondary)', margin: 'var(--space-1) 0 0 0', fontSize: 'var(--text-sm)' }}>Uses standard HTTP headers and status codes. No special transport required.</p>
                </div>
              </div>
              <div style={{ display: 'flex', gap: 'var(--space-3)' }}>
                <span style={{ color: 'var(--accent-brand)', fontWeight: 600, minWidth: '24px' }}>5.</span>
                <div>
                  <strong style={{ color: 'var(--text-primary)' }}>Multiple implementations</strong>
                  <p style={{ color: 'var(--text-secondary)', margin: 'var(--space-1) 0 0 0', fontSize: 'var(--text-sm)' }}>Designed for independent implementations. No single vendor has privileged status.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="card" style={{
            ...
            <h2 style={{ fontSize: 'var(--text-xl)', fontWeight: 600, marginBottom: 'var(--space-4)', display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
              <Quote size={20} style={{ color: 'var(--accent-brand)' }} />
              How to Cite
            </h2>
