        ...
        <article>
          <div className="container" style={{ maxWidth: '900px', margin: '0 auto', padding: 'var(--space-16) var(--space-6)' }}>
            ...
            <nav style={{
              ...
              <span style={{ margin: '0 var(--space-2)' }}>/</span>
              <span style={{ color: 'var(--text-primary)' }}>HTTP 402 for APIs</span>
            </nav>
              ...
              <section style={{ marginBottom: 'var(--space-12)' }}>
                ...
                <div className="card" style={{ background: 'var(--surface-subtle)', marginBottom: 'var(--space-6)' }}>
                  <ol style={{ paddingLeft: 'var(--space-6)', margin: 0 }}>
                    <li style={{ marginBottom: 'var(--space-2)' }}><strong>Status code</strong>: <code style={{ background: 'var(--surface-elevated)', padding: '2px 6px', borderRadius: 'var(--radius-sm)', fontSize: 'var(--text-sm)' }}>402</code></li>
