...
const searchIndex: SearchResult[] = [
  ...
  { title: 'Contact', description: 'Get in touch with us', href: '/company/contact', category: 'Company' },
  { title: 'About', description: 'About Originary and Poem, Inc.', href: '/company/about', category: 'Company' },
