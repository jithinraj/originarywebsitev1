        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2.5fr repeat(4, 1fr)', gap: '2rem' }} className="footer-grid">
          ...
          <div className="footer-brand-col">
            ...
            <div style={{ marginTop: '1.5rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
              ...
              <a href="https://x.com/originaryx" target="_blank" rel="noopener noreferrer" className="footer-icon-hover" style={{ color: 'var(--text-tertiary)', transition: 'color 0.15s ease' }} aria-label="X">
